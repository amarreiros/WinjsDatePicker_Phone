/*
    ...
    With an extension to go close to the Windows 8 control of Alexandre Marreiros
*/
(function () {
    "use strict";
    ...
    var _datePicker = WinJS.Class.define(
		...
		},
		{
		    ...
		    setDaySelect: function (element, index) {
		        ...
		        if (index && index < 3)
		            this.day.style.marginRight = '15px';
		        this.day.style.width = '20%';
		        this.day.id = 'day';
		        for (var i = 1; i <= 31; i++) {
		            var choice = document.createElement('option');
		            choice.setAttribute('value', i);
		    ...
		    setYearSelect: function (element, index) {
		        ...
		        if (index && index < 3)
		            this.year.style.marginRight = '10px';
		        this.year.style.width = '30%';
		        this.year.id = 'year';
		        ...
		        for (var i = this._maxYear; i >= this._minYear ; i--) { //??
		            var choice = document.createElement('option');
		            choice.setAttribute('value', i);
		            choice.textContent = i;
		            this.year.appendChild(choice);
		        ...
		        //this.year.addEventListener('click', function () {
		        //    this.lastChild.scrollIntoView();
		        //});
		    ...
		    setMonthSelect: function (element, index) {
		        ...
		        if (index && index < 3)
		            this.month.style.marginRight = '15px';
		        this.month.style.width = '40%';
		        this.month.id = 'month';
		        for (var i = 1; i <= 12; i++) {
		            var choice = document.createElement('option');
		            choice.setAttribute('value', i);
		    ...
		    //inserted by Innovagency
		    current: {
		        get: function () {
		            return this._getDate();
		        },
		        set: function (value) {
		            this.day.value = value.getDate(); //value.getUTCDate(); this was wrong
		            this.month.value = value.getMonth() + 1; //Javascript calendar strats on 0, since january has the value of zero             
